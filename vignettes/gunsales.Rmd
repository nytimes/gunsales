...
print(ggplot(data=zdf, aes(x=Date, y=Sales)) + geom_line() +
      scale_x_date() + theme_bw(base_size=11) +
...
print(ggplot(data=ndt, aes(x=Date, y=value)) +
      geom_line(aes(colour=variable)) + scale_x_date() + theme_bw(base_size=11) +
    ggtitle("Estimated gun sales per 1000") + xlab("red = adjusted for population growth") +
    ylab("") + theme(legend.position="bottom", legend.title=element_blank()) +
...
print(ggplot(data=dcdf, aes(x=Date, y=Value)) + geom_line() + theme_bw(base_size=11) +
